          ...
          <div className="relative mx-auto max-w-7xl px-6">
            ...
            <div className="max-w-5xl">
              ...
              <p className="mt-8 max-w-3xl text-lg leading-8 text-slate-500 lg:text-xl">
                Track books, uniforms,
                assets, supplies and
                inventory records through
                one centralized school ERP
                platform.
              </p>
                ...
                {[
                  {
                    ...
                    desc:
                      "Track school equipment and assets.",
                  },
                  {
                    title: "Inventory Reports",
                    desc:
                      "Get real-time stock reports.",
                  },
                  {
                    title: "Book Management",
                    desc:
                      "Manage books and educational materials.",
                  },
                  {
                    title: "Supply Monitoring",
                    desc:
                      "Track daily school supplies.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
