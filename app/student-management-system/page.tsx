/* app/student-management-system/page.tsx */
              ...
              <div className="grid gap-6 lg:col-span-7 lg:grid-cols-2">
                ...
                {[
                  ...
                  },
                  {
                    ...
                    desc:
                      "Monitor attendance and activity.",
                  },
                  {
                    title: "Academic Records",
                    desc:
                      "Manage performance and grades.",
                  },
                  {
                    title: "Student Analytics",
                    desc:
                      "Get real-time student insights.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
