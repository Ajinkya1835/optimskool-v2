/* app/payroll-management-system/page.tsx */
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            ...
            <div className="max-w-5xl">
              ...
              <p className="mt-8 max-w-3xl text-lg leading-8 text-slate-500 lg:text-xl">
                Simplify salary processing,
                automate payroll operations,
                generate payslips and manage
                staff payments with one
          ...
          <div className="relative mx-auto max-w-7xl px-6">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-500">
                ...
                automate salary management
                and maintain accurate staff
                payment records.
              </p>
                ...
                {[
                  {
                    ...
                    desc:
                      "Automate salary calculations and staff payments.",
                  },
                  {
                    title: "Payslip Generation",
                    desc:
                      "Generate digital payslips instantly.",
                  },
                  {
                    title: "Payroll Reports",
                    desc:
                      "Track expenses and payroll analytics.",
                  },
                  {
                    title: "Staff Management",
                    desc:
                      "Manage employee salary structures and deductions.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
