/* app/transport-management-system/page.tsx */
...
export const metadata: Metadata =
  generateMetadata({
    title:
      "Transport Management System for Schools | OptimSkool",

    description:
      "Track school buses, routes and student transport operations using OptimSkool Transport Management System.",
                ...
                {[
                  {
                    title: "Bus Tracking",
                    desc:
                      "Track school buses and routes in real-time.",
                  },
                  {
                    title: "Route Management",
                    desc:
                      "Manage pickup and drop routes efficiently.",
                  },
                  {
                    title: "Student Transport",
                    desc:
                      "Assign students to buses digitally.",
                  },
                  {
                    title: "Transport Reports",
                    desc:
                      "Get transport analytics and reports.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
